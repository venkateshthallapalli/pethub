...
<div class="container">
    ...
    %>
            <div class="product-card p-4">
                <div class="row">
                    <div class="col-md-6">
                        <img id="mainProductImage" src="Images/<%= s.getP_image() %>" alt="<%= s.getP_name() %>" class="product-image">
                        <div class="d-flex mt-2">
                            <img class="thumbnail" src="Images/<%= s.getP_image1() %>" alt="Thumbnail 1" onclick="changeImage('Images/<%= s.getP_image1() %>')" style="width: 80px; margin-right: 5px;">
                            <img class="thumbnail" src="Images/<%= s.getP_image2() %>" alt="Thumbnail 2" onclick="changeImage('Images/<%= s.getP_image2() %>')" style="width: 80px; margin-right: 5px;">
                            <img class="thumbnail" src="Images/<%= s.getP_image() %>" alt="Thumbnail 3" onclick="changeImage('Images/<%= s.getP_image() %>')" style="width: 80px;">
                        </div>
                    </div>
                    <div class="col-md-6 description">
                        <h5><%= s.getP_name() %></h5>
                        <p class="price">Rs. <%= s.getP_cost() %></p>
                        ...
                        <form action="addtocart" method="post">
                           ...
                           <label for="quantity-<%= s.getP_id() %>">Quantity:</label>
<select name="quantity" id="quantity-<%= s.getP_id() %>" class="quantity-select">
    ...
    <% } %>
                            ...
                            <% if (session.getAttribute("uname") != null) { %>
                                ...
                                <button type="button" class="wishlist" data-toggle="modal" data-target="#wishlistModal">Add to Wishlist</button>
                            <% } else { %>
...
<div class="reviews mt-4">
            ...
            <div class="pet-care-tips">
                ...
                <ul>
                    ...
                    <li><a href="cat-care-tips.jsp">Essential Cat Care Guidelines</a></li>
            ...
            <div class="nutrition-guidelines">
                ...
                <p>Learn about proper nutrition for your pets. <a href="NutritionGuide.jsp">Read More</a></p>
            </div>
            ...
            <div class="pet-health">
                ...
                <p>Find information on common health issues and preventive care for pets.</p>
                <a href="HealthWellness.jsp">Learn More</a>
            </div>

            <div class="adoption-resources">
                <h6>Pet Adoption:</h6>
                <p>Looking to adopt a pet? <a href="https://amtmindia.org/?gad_source=1&gclid=Cj0KCQjwvpy5BhDTARIsAHSilyleQhxwGcfe_feiCX0g6WmCQLLvJG01k7AdfY8cDpeN31JxbRUpRwcaAnalEALw_wcB">Find local shelters and adoption events</a>.</p>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="addtocart" method="post">
                                <input type="hidden" name="p_id" value="<%= s.getP_id() %>" />
                                <button type="submit" class="btn btn-success" name="addtowishlist">Yes, Add to Wishlist</button>
