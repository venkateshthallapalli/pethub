...
<div class="header">
    ...
    <div class="nav-buttons">
        <a href="dog.jsp?animal=dogfood" class="btn">Food</a>
        <a href="dog.jsp?animal=dogaccessories" class="btn">Accessories</a>
        <a href="dog.jsp?animal=doggrooming" class="btn">Grooming</a>
        <a href="dog.jsp?animal=dogtreats" class="btn">Treats</a>
    </div>
    <div class="logos">
        <a href="Cat.jsp?animal=catfood"><img src="Images1/catlogo.png" alt="Dog Logo"></a>
